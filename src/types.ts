import type { AnyFn, KeyOf } from '@rhao/types-base'

export type HookCallback = AnyFn
...
export interface DeprecatedHook<T> {
  message?: string
  to: HookKeys<T>
}

export type DeprecatedHooks<T> = Record<HookKeys<T>, DeprecatedHook<T>>
